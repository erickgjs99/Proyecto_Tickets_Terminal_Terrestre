"""
Terminal Terrestre — Configuración Django (HTML Templates, sin React)
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "terminal_terrestre"),
...
LOGGING = {
    ...
    "loggers": {
        ...
        "apps.qr_codes.services": {"handlers": ["console"], "level": "DEBUG", "propagate": False},
    },
}

# Django messages tags → CSS classes
